...
Final steps
1) make a book now vs book later button. Should just be an easy toggle. check. Then add that value to the scrape arguments. GG
2) Try exporting and test with the exe.